...
function populateDonationDetails(data) {
    ...
    // Transaction ID
    $('#transaction-id-display').text(data.transactionId);
    ...
    const authorPicUrl = data.authorProfileDto.profilePicUrl || 'https://th.bing.com/th/id/OIP.WL3sW0IMrqdClc5xocICSgHaHa?w=900&h=900&rs=1&pid=ImgDetMain';
